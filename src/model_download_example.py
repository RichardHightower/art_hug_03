...
def download_specialized_models():
    ...
    return {
        'qa': (qa_model, qa_tokenizer),
        'ner': (ner_model, ner_tokenizer)
    }
...
def main():
    ...
    sentiment_model, sentiment_tokenizer = download_sentiment_model()
    multilingual_model, multilingual_tokenizer = download_multilingual_model()
    specialized_models = download_specialized_models()
    gpt2_model, gpt2_tokenizer = download_with_specific_revision()
